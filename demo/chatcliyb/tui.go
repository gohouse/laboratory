...
func ui(c IChat) {
	...
	middlePage.SetTextColor(tcell.ColorGray)
	// 不断获取新消息
	...
	middlebottom.SetPlaceholderTextColor(tcell.ColorGray)
	middlebottom.SetFieldTextColor(tcell.ColorOrange).SetLabelWidth(1).
